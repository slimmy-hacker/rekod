...
<!-- New Menu Items -->
<li>
    <a href="/student/logbook" class="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">Logbook</a>
</li>
<li>
    <a href="/student/attachment-form" class="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">Attachment Form</a>
</li>
<li>
    <a href="/student/reports" class="block py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">Reports</a>
</li>
