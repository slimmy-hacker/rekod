                    ...
                    <li>
                        <a href="{{ route('lecturer.portal') }}" class="text-base text-white font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 hover:text-gray-900 group">
                    ...
                    <li>
                        <a href="{{ route('lecturer.my-students') }}"  class="text-base text-white font-normal rounded-lg hover:bg-gray-100 hover:text-gray-900 flex items-center p-2 group ">
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">My students</span>

                        </a>
                    </li>
                    <li>
                        <a href="{{ route('lecturer.weekly-reports') }}" class="text-base text-white font-normal rounded-lg hover:bg-gray-100 hover:text-gray-900 flex items-center p-2 group ">
                    ...
                    <li>
                        <a href="{{ route('lecturer.final-reports') }}" class="text-base text-white font-normal rounded-lg hover:bg-gray-100 hover:text-gray-900 flex items-center p-2 group ">
                            <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-white transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>
