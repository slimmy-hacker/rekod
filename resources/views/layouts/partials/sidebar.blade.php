            ...
            <div class="flex-1 px-3 bg-blue-500 divide-y space-y-1">
                <ul class="space-y-2 pb-2">
                 ...
                 @if(Auth::check() && Auth::user()->role)
                    ...
                    <a href="{{ route('attachment_selected.select') }}" class="text-base text-white font-normal rounded-lg  hover:text-red-600 group transition duration-75 flex items-center p-2 mb-4">

                    <a href="{{ route('attachment.select') }}" class="text-base text-white font-normal rounded-lg  hover:text-red-600 group transition duration-75 flex items-center p-2 mb-4">
>
                ...
                @endif
                    <a href="{{ route('attachment.select') }}" class="text-base text-white font-normal rounded-lg  hover:text-red-600 group transition duration-75 flex items-center p-2 mb-4">
                        ...
                        <span class="ml-3">Attachments</span>
                    </a>
                </ul>
