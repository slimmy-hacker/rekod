        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/" class="text-xl font-bold flex items-center lg:ml-2.5">
                    <img src="https://applyscholars.com/wp-content/uploads/2022/10/DeKUT-logo.png" class="h-6 mr-2" alt="Dekut Logo">
                    <span class="self-center whitespace-nowrap">DAMS</span>
                </a>
