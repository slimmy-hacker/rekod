            ...
            <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
                <div class="mb-1 w-full">
                    <div class="mb-4">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#" class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">Lecturers</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">All Staffs</h1>
                    </div>
                            ...
                            <form id="scheduleForm" enctype="multipart/form-data">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-6">
                                        <label for="name" class="text-sm font-medium text-gray-900 block mb-2">Lecturers Excel <span class="text-red-500">*</span></label>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table = $("#attarchment_schedules_table").DataTable({
                ...
                serverSide: true,
                ordering: false,
                ajax: "{{ route('admin.lecturers.index') }}",
                columns: [
            ...
            $("#scheduleForm").on("submit", function (e) {
                ...
                $.ajax({
                    url: "{{ route('admin.lecturers.upload') }}", // adjust route name
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
